...
export const statusStyle = (s, T) => ({
  ...
  low_stock: { bg: T.yellowL, fg: T.yellow },
  out_of_stock: { bg: T.redL, fg: T.red },
  'Low Stock': { bg: T.yellowL, fg: T.yellow },
  'Out of Stock': { bg: T.redL, fg: T.red },
  pending: { bg: T.yellowL, fg: T.yellow },
  confirmed: { bg: T.blueL, fg: T.blue },
  processing: { bg: T.tealLt, fg: T.teal },
  shipped: { bg: T.tealLt, fg: T.teal },
